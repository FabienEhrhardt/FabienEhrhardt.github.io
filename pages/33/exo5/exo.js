...
// CANVAS
// =====================
function tracerBilanPuissanceStylise(canvasId, afficherValeurs=false){
    ...
    if(afficherValeurs>0){ctx.fillText(`Pa = ${Pa} kW`, 50, y-50);}
    if(afficherValeurs>1){ctx.fillText(`Pu = ${Pu} kW`, 380, y-50);}
    if(afficherValeurs>2){ctx.fillText(`Pj = ${Pj} kW`, 200, y+120);}
    if(afficherValeurs>3){ctx.fillText(`Pf = ${Pfe} kW`, 280, y+105);}
	
	let couleur="black";
	ctx.fillStyle = couleur;
	ctx.font = "14px Arial";
	ctx.textAlign = "center";
	ctx.fillText("Pa",75,y);
	tracerFleche(canvasId,100,y,300,100,0,"Pu",couleur);
	ctx.fillRect(100,y,100, 90);
	ctx.fillRect(100,y,200, 70);
	tracerFleche(canvasId,175,y,150,50,60,"Pf",couleur);
	tracerFleche(canvasId,275,y,150,50,60,"Pj",couleur);
	tracerFleche(canvasId,100,y,300,100,0,"Pu",couleur);
}
